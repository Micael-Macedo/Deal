...
namespace Deal.Controllers
{
    public class ServicoController : Controller
    {
        ...
        public ServicoController(ProjectDealContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Servicos != null ? 
                          ...
                          Problem("Entity set 'ProjectDealContext.Servicos'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ServicoId,Nome,Descricao,Localizacao,Cep,Categoria,Status")] Servico servico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ServicoId,Nome,Descricao,Localizacao,Cep,Categoria,Status")] Servico servico)
        {
